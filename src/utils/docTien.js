var DocTienBangChu = function () {
  ...
  this.Tien = new Array("", " ngàn", " triệu", " tỷ", " ngàn tỷ", " triệu tỷ");
};
...
DocTienBangChu.prototype.doc = function (SoTien) {
    ...
    if (soAm) {
        return "Âm " + KetQua + " đồng chẵn";//.substring(0, 1);//.toUpperCase();// + KetQua.substring(1);
    }
    else {
        return KetQua + " đồng chẵn";//.substring(0, 1);//.toUpperCase();// + KetQua.substring(1);
    }
}
export default new DocTienBangChu()